...
class HazardMgr : public AppCastingMOOSApp
{
 ...
 protected: // Registration, Configuration, Mail handling utils
   ...
   void handleMailHazardSetReport(std::string);
   void handleMailNodeMessage(std::string);
   void handleMailHazardReportJake(std::string); //Jocelyn
   void handleMailHazardReportKasper(std::string);
   void handleMailWaypoint(std::string);
 ...
 private: // State variables
   ...
   std::string      m_othership;
   std::string      m_hazfriend; //Jocelyn
   std::list<std::string> m_hazards;
