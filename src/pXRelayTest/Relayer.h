...
class Relayer : public CMOOSApp
{
 public:
  ...
  void setIncomingVarA(std::string s) {m_incoming_var_a=s;};
  void setIncomingVarB(std::string s) {m_incoming_var_b=s;};//set as array
 ...
 protected:
  ...
  std::string       m_incoming_var_a;
  std::string       m_incoming_var_b;
